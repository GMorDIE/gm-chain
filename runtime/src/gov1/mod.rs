...
mod origins;
pub use origins::{
    pallet_custom_origins, Baggooooor, GeneralAdmin, ReferendumCanceller, ReferendumKiller,
    ShipBigLadAndUp, ShipMassiveLegendAndUp, ShipPrePissers, ShipUberGigaChadAndUp, Spender,
    WhitelistedCaller,
};
mod tracks;
pub use tracks::TracksInfo;
mod ship;
pub use ship::{ShipCollectiveInstance, ShipReferendaInstance};
...
impl pallet_whitelist::Config for Runtime {
    ...
    type WhitelistOrigin =
        EitherOf<EnsureRootWithSuccess<Self::AccountId, ConstU16<65535>>, ShipBigLadsAndUp>;
