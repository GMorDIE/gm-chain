...
impl<Balance: Saturating> AccountVote<Balance> {
    ...
    /// The balance involved in this vote split into aye and nay.
    pub fn balance_split(self) -> (Option<Balance>, Option<Balance>) {
        match self {
            ...
            AccountVote::Split { aye, nay } => (Some(aye), Some(nay)),
        }
    }
