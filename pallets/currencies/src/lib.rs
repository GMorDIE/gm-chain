...
pub mod module {
    ...
    pub trait Config: frame_system::Config {
        ...
        #[pallet::constant]
        type GetGMCurrencyId: Get<CurrencyIdOf<Self>>;

        #[pallet::constant]
        type GetGNCurrencyId: Get<CurrencyIdOf<Self>>;
    ...
    pub enum Event<T: Config> {
        ...
        FrenBurned {
            who: T::AccountId,
            amount: BalanceOf<T>,
            what_they_got: Option<CurrencyIdOf<T>>,
        },
    }
    ...
    #[pallet::storage]
    #[pallet::getter(fn current_time_period)]
        ...
        BalanceOf<T>: From<u128>,
    {
            ...
            BalanceOf<T>: From<u128>,
        {
            ...
            // Minting GM/GN or just doing nothing if you got the time wrong
            let what_they_got = match CurrentTimePeriod::<T>::get() {
                TimePeriod::Morning => {
            ...
            Self::deposit_event(Event::FrenBurned {
                who: fren,
                amount,
                what_they_got,
            });
