...
fn pallet_multicurrency_deposit_events() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_eq!(
                <Tokens as MultiCurrency<AccountId>>::slash(DOT, &ALICE, 60),
                0
            );
...
fn pallet_multicurrency_extended_deposit_events() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            assert_ok!(
                <Tokens as MultiCurrencyExtended<AccountId>>::update_balance(DOT, &ALICE, 500)
            );
            System::assert_last_event(Event::Tokens(crate::Event::Deposited {
                currency_id: DOT,
                who: ALICE,
...
fn pallet_multi_reservable_currency_deposit_events() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_ok!(
                <Tokens as MultiReservableCurrency<AccountId>>::repatriate_reserved(
                    DOT,
                    &ALICE,
                    &BOB,
                    100,
...
fn pallet_fungibles_mutate_deposit_events() {
    ExtBuilder::default()
        ...
        .build()
        .execute_with(|| {
            assert_ok!(<Tokens as fungibles::Mutate<AccountId>>::mint_into(
                DOT, &ALICE, 500
            ));
            System::assert_last_event(Event::Tokens(crate::Event::Deposited {
                currency_id: DOT,
...
fn currency_adapter_pallet_currency_deposit_events() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            std::mem::forget(<MockCurrencyAdapter as PalletCurrency<AccountId>>::burn(
                500,
            ));
            System::assert_last_event(Event::Tokens(crate::Event::TotalIssuanceSet {
                currency_id: DOT,
            ...
            std::mem::forget(<MockCurrencyAdapter as PalletCurrency<AccountId>>::issue(
                200,
            ));
            System::assert_last_event(Event::Tokens(crate::Event::TotalIssuanceSet {
                currency_id: DOT,
            ...
            assert_ok!(
                <MockCurrencyAdapter as PalletCurrency<AccountId>>::transfer(
                    &ALICE,
                    &BOB,
                    50,
            ...
            std::mem::forget(<MockCurrencyAdapter as PalletCurrency<AccountId>>::slash(
                &BOB, 110,
            ));
            System::assert_last_event(Event::Tokens(crate::Event::Slashed {
                currency_id: DOT,
